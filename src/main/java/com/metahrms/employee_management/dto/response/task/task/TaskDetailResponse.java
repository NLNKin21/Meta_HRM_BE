...
@Schema(description = "Task detail response (for detail view)")
public class TaskDetailResponse {
    ...
    @Schema(description = "Task type", example = "FEATURE")
    String taskType;
    ...
    @Schema(description = "Approver ID", example = "3")
    Integer approverId;

    @Schema(description = "Approver name", example = "Le Van C")
    String approverName;
    ...
    @Schema(description = "Completed date", example = "10/02/2024 14:30:00")
    ...
    @Schema(description = "List of histories")
    ...
    // ========== PERMISSIONS ==========
    @Schema(description = "Can current user edit?", example = "true")
    Boolean canEdit;

    @Schema(description = "Can current user delete?", example = "false")
    Boolean canDelete;

    @Schema(description = "Can current user comment?", example = "true")
    Boolean canComment;
    ...
    public static class Builder {
        ...
        public Builder statusColor(String statusColor) { this.statusColor = statusColor; return this; }
        ...
        public Builder reporterId(Integer reporterId) { this.reporterId = reporterId; return this; }
        ...
        public Builder comments(List<TaskCommentResponse> comments) { this.comments = comments; return this; }
        public Builder histories(List<TaskHistoryResponse> histories) { this.histories = histories; return this; }
        ...
        public Builder canComment(Boolean canComment) { this.canComment = canComment; return this; }
        public Builder createdAt(LocalDateTime createdAt) { this.createdAt = createdAt; return this; }
        public Builder updatedAt(LocalDateTime updatedAt) { this.updatedAt = updatedAt; return this; }

        public TaskDetailResponse build() {
            ...
            response.approverId = this.approverId;
            response.approverName = this.approverName;
